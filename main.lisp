...
(defun generate-lists ()
  (let ((critical-keys (distill-reading *keys* '(:obvious-correction :omitted-text :diplomatic))))
    ...
    (write-list "verkuerzungen.tex"
                ...
                critical-keys)
    (write-list "verkuerzungen-vergleich.tex"
...
(defun generate-spreadsheets ()
  (let ((critical-keys (distill-reading *keys* '(:obvious-correction :omitted-text :diplomatic))))
    (write-spreadsheet "debug.tex"
                       "Inventar aller Intervalle"
                       "Sämtliche Intervalle, nach ihrer Grösse in \\texttt{:tuning1} sortiert."
                       :tuning1
